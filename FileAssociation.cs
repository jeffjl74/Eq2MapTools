...
namespace EQ2MapTools
{
    ...
    public static class FileAssociation
    {
        ...
        public static string? GetExecCommandAssociatedToExtension(string ext, string verb = "open")
        {
            if (ext[0] != '.')
            {
                ext = "." + ext;
        ...
        /// <param name="verb"></param>
        /// <returns>Return null if not found</returns>
        public static string? GetExecFileAssociatedToExtension(string ext, string verb = "open")
        {
            if (ext[0] != '.')
            {
                ext = "." + ext;
